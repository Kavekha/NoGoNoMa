...
from player_systems.try_move_player import try_move_player, try_next_level, move_order_player
...
def player_input():
    ...
    if terminal.has_input():
        ...
        if key == terminal.TK_MOUSE_LEFT:
            print(f'clic on screen : {mouse_map_pos_x, mouse_map_pos_y}')   # Zoom!
