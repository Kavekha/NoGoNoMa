...
DEFAULT_CONFUSION_INITIATIVE_COST = 5

DEFAULT_ITEM_ATTRIBUTE_MODIFIER_DURATION = 10
DEFAULT_SLOW_DURATION = 5
DEFAULT_DOT_DURATION = 5
...
UI_MANA_BAR_WIDTH = 10
COLOR_MANA_BAR_VALUE = 'blue'
COLOR_MANA_BAR_BACKGROUND = 'darker blue'
COLOR_TEXT_MANA_BAR = 'grey'
...
COLOR_MAGIC_ITEM_COMMON = 'white'
COLOR_MAGIC_ITEM_UNCOMMON = 'green'
COLOR_MAGIC_ITEM_RARE = 'blue'
COLOR_MAGIC_ITEM_EPIC = 'violet'
COLOR_MAGIC_ITEM_LEGENDARY = 'orange'
COLOR_MAGIC_ITEM_CURSED = 'red'
